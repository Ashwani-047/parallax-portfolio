...
window.addEventListener("scroll", ()=>{
  ...
  projectsTitle.style.transform = `translateY(calc(405vh - ${offsetY}px))`
  phones[0].style.transform = `translateX(calc(480vh - ${offsetY}px))`
  laptop.style.transform = `translateX(calc(620vh - ${offsetY}px))`
  phones[1].style.transform = `translateX(calc(740vh - ${offsetY}px))`
})